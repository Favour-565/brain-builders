...
const LandingPage = () => {
  return (
    <div className="w-full relative bg-[#f9f4f4] overflow-hidden flex flex-col items-end justify-start pt-[0px] px-[0px] pb-[145px] box-border gap-[125px] leading-[normal] tracking-[normal] text-left text-[32px] text-[#002724] font-[Nexa] lg:gap-[62px] mq361:gap-[16px] mq400:gap-[31px]">
      <Main />
      <FrameComponent2 />
